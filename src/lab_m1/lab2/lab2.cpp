...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        vector<VertexFormat> vertices
        {
            ...
            VertexFormat(glm::vec3(0, 0,  0), glm::vec3(0.5, 0, 1)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.5, 0, 1)),
            VertexFormat(glm::vec3(0,  1,  0), glm::vec3(0.5, 0, 1)),
            VertexFormat(glm::vec3(1,  1, 0), glm::vec3(0.5, 0, 1)),
        };
    ...
    meshes["tetrahedron"]->InitFromData(vertices2, indices2);
...

    {
        ...
        for (unsigned int i = 0; i < NrSlices; i++) {
            ...
            indices8.push_back(i);
        }

        meshes["circle"] = new Mesh("generated cercle");
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(-0.5f, 1, 0), glm::vec3(0.5f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(-2.5f, 0, 0), glm::vec3(1));

    // TODO(student): Draw the square
    RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(-4.5f, 0, 0), glm::vec3(0.5f));

   // RenderMesh(meshes["circle"], shaders["VertexColor"], glm::vec3(-6.5f, 0.5f, -3), glm::vec3(0.75f));
